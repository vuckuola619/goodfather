...
def test_calculate_dimensions():
    ...
    answers = {
        ...
        "sectionD": {"d1": 5, "d2": 5, "d3": 5, "d4": 1, "d5": 5, "d6": 5},
        "sectionE": {"e1": 5, "e2": 5, "e3": 5, "e4": 5, "e5": 1, "e6": 5},
        "sectionB": [],
        "sectionF": [],
    }
...
def test_determine_result_type():
    ...
    assert (
        determine_result_type(scores2, "3–5 tahun", [])
        == "Anak Butuh Routine & Boundaries"
    )
    ...
    assert (
        determine_result_type(scores5, "13–17 tahun", ["sering melawan"])
        == "Pre-Teen / Teen Communication"
    )
        ...
        "profiles": [
            {
                ...
                "badges": [{"id": "istiqamah", "unlocked": False, "progress": "2/3"}],
            }
        ]
    }
